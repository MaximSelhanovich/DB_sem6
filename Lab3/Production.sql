...
ALTER TABLE MyChildTable ADD CONSTRAINT fk_mytable_id
...
CREATE OR REPLACE PROCEDURE prosedure_to_delete(PAR1 VARCHAR2, PAR2 NUMBER)
IS
    N BOOLEAN;
BEGIN
    N := TRUE;
END prosedure_to_delete;
